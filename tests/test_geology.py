...
def test_route_score_applies_geology_penalty_per_km():
    ...
    # include a station at the demand point to ensure full coverage while keeping
    # the alignment straight; turn penalties belong to a separate part of the objective.
    points = [start, mid, end]

    penalty = 12_345.0
    config = pl.MetroConfig(
        geology_penalty_per_km=penalty,
